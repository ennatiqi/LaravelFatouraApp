...
<div class="page-content">
    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('add_invoices') }}" method="post" enctype="multipart/form-data"
                        autocomplete="off">
                        {{ csrf_field() }}
                        {{-- 1 --}}
                        ...
                        <div class="row">
                            <div class="col">
                                <label for="inputName" class="control-label">num invoices</label>
                        ...
                        <div class="row">
                            <div class="col">
                                <label for="inputName" class="control-label">The value of the added tax</label>
