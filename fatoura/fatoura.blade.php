                            ...
                            <tbody>
                                ...
                                @foreach ($invoices as $invoice)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        <form action="{{ route('Invoices_Details') }}" id="InvoicesDetails" method="get">  
                                        ...
                                        <td>
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <button class="dropdown-item"
                                                            > <i class="mdi mdi-grease-pencil me-2"></i>Edit invoice</button>
                                                </form>
                                                            ...
                                                            <input name="id" type="hidden" value="{{ $invoice->id }}">   
                                                    <button class="dropdown-item"><i class=" text-success fas fa-money-bill"></i>&nbsp;&nbsp;Payment status</button>
                                                            </form>
                                                    <a class="dropdown-item" href="#" data-invoice_id="{{ $invoice->id }}"
                                                            data-toggle="modal" data-target="#Transfer_invoice"><i
                                                                class="text-warning fas fa-exchange-alt"></i>&nbsp;&nbsp;Archived</a>
