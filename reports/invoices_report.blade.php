        ...
        <div class="card mg-b-20">
            ...
            <div class="card-header pb-0">
                ...
                <form action="/Search_invoices" method="POST" role="search" autocomplete="off">
                    ...
                    <div class="col-lg-3">
                        <label class="rdiobox">
                            <input checked name="rdio" type="radio" value="1" id="type_div"> <span>Invoice type search 
                                </span></label>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 mg-t-20 mg-lg-t-0" id="type">
                            <p class="mg-b-10">Determine the type of invoice</p><select class="form-control select2" name="type"
                                required>
                                ...
                                <option value="partrier">invoices partrier</option>
                        ...
                        <div class="col-lg-3" id="start_at">
                            ...
                            <div class="input-group">
                                <input class="form-control " value="{{ $start_at ?? '' }}"
                            ...
                            <tbody>
                                ...
                                @foreach ($details as $invoice)
                                    ...
                                    <tr>
                                        ...
                                        <td><a
                                                href="{{ url('InvoicesDetails') }}/{{ $invoice->id }}">1</a>
                                        </td>
