                    ...
                    <form action="{{ route('Status_Update', ['id' => $invoices->id]) }}" method="post" autocomplete="off">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input class="form-control" name="invoice_Date"  id="example-date-input" placeholder="YYYY-MM-DD"
                                    type="date" value="{{ date('Y-m-d') }}" required readonly>
                            </div>

                            <div class="col">
                                <label>تاريخ الاستحقاق</label>
                                <input class="form-control " name="Due_date" id="example-date-input" placeholder="YYYY-MM-DD"
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select name="client" class="form-control SlectBox" onclick="console.log($(this).val())"
                                    onchange="console.log('change is firing')" readonly>
                                    <!--placeholder-->
                                    <option >
                                    {{$invoices->client->first_name}}
                                    </option>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select class="form-control" id="Status" name="Status" required>
                                    ...
                                    <option value="partrier ">partrier</option>
                                </select>
                            </div>

                            <div class="col">
                                <label>تاريخ الدفع</label>
                                <input class="form-control " name="Payment_Date" placeholder="YYYY-MM-DD"
                                    type="date" required>
                            </div>
